...
export default function TextbookFloatingPopup() {
  ...
  if (collapsed) {
    return (
      <button
        ...
        className="fixed right-0 top-32 z-30 hidden flex-col items-center gap-1 rounded-l-xl bg-gradient-to-b from-amber-500 via-orange-500 to-rose-500 px-2 py-3 text-white shadow-xl transition hover:px-3 lg:flex"
      >
  ...
  return (
    <aside
      className={`fixed right-4 top-32 z-30 hidden w-60 lg:block ${entered ? "translate-x-0 opacity-100" : "translate-x-8 opacity-0"} transition-all duration-500 ease-out`}
    >
